...
class starter {
	public static void main(String args[]) {
        ...
        */
        ...
        if(diff == 1){
            // susans notes:
            // make an array that conatins one element and display it to the user 
            //then call the countdown 
            //promt the persson the user to give u data that will fill the array 
            // you will comare the 2 arrays (output and input) if same keep going if not, cut .. game over 
            // if it continues then i pull a random color into MY array 
           // mine : green , blue + rando not acc push it will change the array leangh by adding a numer to the end
            // i will pronmt them for theri imput and put that into the imput array and comare putput w/ imput 
        ...
        System.out.println("/nMemorize the sequence " );
        clearScreen();
        ...
        if(checkType[i]==1){
            correct = getSimpleColorName(textColor[i]);
        }
...
public static String getColorWord(){
    ...
    int index = (int)(Matg.random()* colors.length);
    return color[index];
}
...
public static String getSimpleColorName (String s) {
    ...
    if(s.equals("BRIGHT_BG_YELLOW")) {
    return"YELLOW";
    }
    if(s.equals("BRIGHT_BG_PURPLE")) {
    return"PURPLE";
    }
    return s;
}
        //}
      //  output[0]=getColorWord();
     ...
     //   }
      ...
      //  else if(diff == 2){
            ...
            // susans :
            // randomly give be 2 things, word color , font color or bg the same way i did the forst one 
            // format to output match that what i picked 
            // array for word volor and text color 
            // then tell them which one they should gove me back so wjen i take their array in i only comare it to one of thoes 
            // they aweser and u put it in array ,whatever they match to (another random array to decide which one ), match or not 
            // kepp adding to the end and runnimg it 
    ...
    //    }
     //   else if(diff == 3){
            // susans :
            // randomly give be 3 things, word color , font color or bg the same way i did the forst one 
            // format to output match that what i picked 
            // array for word volor and text color 
            // then tell them which one they should gove me back so wjen i take their array in i only comare it to one of thoes 3
            // they aweser and u put it in array ,whatever they match to (another random array to decide which one ), match or not 
            // kepp adding to the end and runnimg it 
            /*
                Difficulty level 3:
...
//        for(int i = 0; i < arr.length; i++){
 ...
 //       }
  //      System.out.println(); // this prints put color list (my edit)
//	}
