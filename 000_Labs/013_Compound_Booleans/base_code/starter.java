...
class starter {
	...
	Scanner sc = new Scanner(System.in);
        ...
        int num1 = sc.nextInt();
        System.out.println(" Please enter your seccond number:");
        int num2 = sc.nextInt();
        ...
        if ((num2 > num1) && (num2 > num3)){
        	System.out.println("Your seccond number is the largest of the three!");
        ...
        if ((num3 > num1) && (num3 > num2)){
         ...
         if ((num1 < num2) && (num1 < num3)){
        	 ...
        	 if ((num2 < num1) && (num2 < num3)){
        		int smallest = num2;
        		System.out.println("Your seccond number is the smallest of the three!");
        		System.out.println(" this is the smallest number " + smallest);
        	 }
